document.addEventListener("DOMContentLoaded", () => {
    ...
    function escribirSecuencia() {
        if (textoIndex < textos.length) {
            ...
            // Muestra el botón de la portada al finalizar el tipeo
    ...
    // ==========================================
    // 4. REPRODUCCIÓN Y CONTROL DE MÚSICA DE FONDO
    // ==========================================
    ...
    // Activa la música al dar el primer toque/clic en cualquier parte de la pantalla
    document.body.addEventListener("click", playAudio, { once: true });
    document.body.addEventListener("touchstart", playAudio, { once: true });

    // Control manual si existe un botón con id "music-toggle"
    if (musicBtn) {
